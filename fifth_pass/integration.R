...
source("fifth_pass/welfare_analysis_framework.R")  # Main analysis functions
source("fifth_pass/human_welfare_module.R")  # Human welfare calculations
source("fifth_pass/wild_animal_module.R")  # Wild animal welfare calculations
